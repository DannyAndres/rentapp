          ...
          <div className="mb-12 w-full flex justify-start items-start">
            {parseInt(page != null ? page : '1') > 1 && (
              <Button
                ...
                onClick={() => {
                  navigate(
                    `/locations?page=${parseInt(page != null ? page : '1') - 1}`
                  );
                }}
                color="primary"
              >
            ...
            {result.results.map((data, index) => (
              <Card key={index} className="max-w-[400px]">
                ...
                <CardBody className="block">
                  <Chip className="mr-2 mb-2">{data.dimension}</Chip>
                  <Chip color="primary" className="mr-2 mb-2">
                    Number of residents: {data.residents.length}
                  </Chip>
                </CardBody>
              </Card>
            ))}
