  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-green-900 dark:text-gray-200">
          Create an account
        </h2>
      </div>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <p className="mt-10 text-center text-sm text-gray-500">
          Already a member?{' '}
          <button className="font-semibold leading-6 text-green-600 hover:text-indigo-500">
            Log in with your account here
          </button>
        </p>
      </div>
    </div>
